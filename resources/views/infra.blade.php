        ...
        <div class="menu  " style="background-color:black ">
            <nav>
                <div class="row " style="margin-top: 10%; margin-bottom:10%; ">
                    <div class="col">
                        <img src="https://projetokilberty.blob.core.windows.net/sftp/imagens/logo_softcom_branca.png"
                            style="width: 180px; heigth:50px;">
                    </div>
                </div>
                ...
                <ul class="navbar-nav sidebar sidebar-dark accordion">
                    ...
                    <li><a href="/clientes" class="nav-link menuitem rotaativa"><span
                                style="margin-left:10px">Clientes</span></a></li>
                    <li>
                    ...
                    <li><a href="/clientes" class="nav-link menuitem"><span style="margin-left:10px">Meu
                                Carrinho</span></a></li>
            ...
            <div class="divLogout">
                <div class="row" style="height: 100%">
                    <div class="col" style="height: 100%">
                        <button style="width: 100%; border:none; border-radius:0px; color:white;  height:100%"
                            onclick="logout()" class="btn btn-dark"> Logout</button>
            ...
            <div class="container-fluid bg-dark" style="height:15%;">
                ...
                <div class="row" style="width: 100%; height:100%">
                    ...
                    <div class="col-2 bg-dark " style="padding-right:0px; display:flex;">
                        <div class="botoes">
                            <button class="btn btn-primary" type="button" style="margin-top: 2%"
                            ...
                            <table class="table table-bordered ">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-center" style="width: 10%">
                                            @if ($pc->Caixa == 1)
                                            <button class="btn btn-outline-dark">Baixar</button>
                                        </th>
                                        ...
                                        <th class="text-center" style="width: 10%">
                                            <button class="btn btn-outline-dark" type="button" data-toggle="modal"
                                                data-target="#exampleModal">Visualizar</button>
                                        </th>
